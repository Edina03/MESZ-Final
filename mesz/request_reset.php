            ...
            <ul class="navbar-nav">
                ...
                <?php else: ?>
                    ...
                    if (isset($_SESSION['doctorID'])) {
                        echo '<li class="nav-item"><a class="nav-link" href="add_patient_records.php">Karton írása</a></li>';
                        echo '<li class="nav-item"><a class="nav-link" href="view_patient_records.php">Kartonok megtekintése</a></li>';
                        echo '<li class="nav-item"><a class="nav-link" href="view_patient_health.php">Fogak állapota</a></li>';
